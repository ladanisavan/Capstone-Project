...
import com.nanodegree.android.showtime.ShowSeasonsFragment;
...
public class SeasonsAdapter extends CursorTreeAdapter {
    ...
    protected Cursor getChildrenCursor(Cursor groupCursor) {
        ...
        CursorLoader cursorLoader = new CursorLoader(mContext,
                StContract.EpisodeEntry.buildSeasonEpisodesUri(seasonId), EPISODE_COLUMNS,
                            null, null, StContract.EpisodeEntry.COLUMN_NUMBER);
