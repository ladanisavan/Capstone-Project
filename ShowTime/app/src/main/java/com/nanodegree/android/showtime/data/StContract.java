...
/**
 * Defines table and column names for the ShowTime database.
 */
public class StContract {

    public static final String CONTENT_AUTHORITY = "com.nanodegree.android.showtime";
    ...
    public static final class SeasonEntry implements BaseColumns {
        ...
        public static final Uri SHOW_SEASONS_CONTENT_URI =
                StContract.ShowEntry.CONTENT_URI.buildUpon()
                        .appendPath(StContract.PATH_SEASONS).build();
    ...
    public static final class EpisodeEntry implements BaseColumns {
        ...
        public static final Uri SEASON_EPISODES_CONTENT_URI =
                StContract.SeasonEntry.CONTENT_URI.buildUpon()
                        .appendPath(StContract.PATH_EPISODES).build();
    ...
    public static final class CommentEntry implements BaseColumns {
        ...
        public static final Uri SHOW_COMMENTS_CONTENT_URI =
                StContract.ShowEntry.CONTENT_URI.buildUpon()
                        .appendPath(StContract.PATH_COMMENTS).build();
        public static final Uri EPISODE_COMMENTS_CONTENT_URI =
                StContract.EpisodeEntry.CONTENT_URI.buildUpon()
                        .appendPath(StContract.PATH_COMMENTS).build();
