 ...
 */
public class StSyncAdapter extends AbstractThreadedSyncAdapter {

    private final String LOG_TAG = StSyncAdapter.class.getSimpleName();

    public static final String ACTION_DATA_UPDATED =
            "com.nanodegree.android.showtime.ACTION_DATA_UPDATED";
    ...
    public StSyncAdapter(Context context, boolean autoInitialize) {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        try {
            Log.d(LOG_TAG, "StSyncAdapter started");
            ...
            updateValues.put(StContract.ShowEntry.COLUMN_POPULARITY, 0);
            getContext().getContentResolver().update(StContract.ShowEntry.CONTENT_URI, updateValues,
                    null, null);

            List<Integer> showIds =
                    Utility.synchronizePopularShowsData(getContext(), LOG_TAG, traktService, posterService);
            ...
            Log.d(LOG_TAG, "StSyncAdapter correctly ended");
        } catch (Exception e) {
    ...
    public static void syncImmediately(Context context) {
        ...
        ContentResolver.requestSync(getSyncAccount(context), StContract.CONTENT_AUTHORITY, bundle);
    }
    ...
    public static void configurePeriodicSync(Context context, int syncInterval, int flexTime) {
        ...
        String authority = StContract.CONTENT_AUTHORITY;
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        StSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);

        /*
         * Without calling setSyncAutomatically, our periodic sync will not be enabled.
         */
        ContentResolver.setSyncAutomatically(newAccount, StContract.CONTENT_AUTHORITY, true);
