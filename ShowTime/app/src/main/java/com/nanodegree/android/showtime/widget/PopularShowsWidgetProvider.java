...
import com.nanodegree.android.showtime.MainActivity;
import com.nanodegree.android.showtime.R;
import com.nanodegree.android.showtime.ShowDetailActivity;
import com.nanodegree.android.showtime.sync.StSyncAdapter;
...
public class PopularShowsWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(@NonNull Context context, @NonNull Intent intent) {
        ...
        if (StSyncAdapter.ACTION_DATA_UPDATED.equals(intent.getAction())) {
